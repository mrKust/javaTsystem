...
* Author name : {Vasilyev Dmitry}
* Codeship : {[![javaExamTesting](https://github.com/mrKust/javaTsystem/actions/workflows/testing.yml/badge.svg)](https://github.com/mrKust/javaTsystem/actions/workflows/testing.yml)}
